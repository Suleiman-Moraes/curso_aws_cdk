...
public class DdbStack extends Stack {
	...
	public DdbStack(final Construct scope, final String id, final StackProps props) {
		...
		productEventsDdb = Table.Builder.create(this, "ProductEventsDb").tableName("product-events")
		...
		productEventsDdb.autoScaleReadCapacity(EnableScalingProps.builder().minCapacity(1).maxCapacity(2).build())
